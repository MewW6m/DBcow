...
@Transactional
@SpringBootTest
public class PatchConnectDetailTest {
    ...
    void postUserDetailTest1() throws Exception {
        mockMvc.perform(patch("/api/connect/con5")
    ...
    void postUserDetailTest3() throws Exception {
        mockMvc.perform(patch("/api/connect/xxxx")
                .with(csrf()).content("{\"status\":0,\"conname\":\"xxxx\",\"dbtype\":\"3\",\"host\":\"localhost\",\"user\":\"user1\",\"password\":\"pass1\",\"dataregistflag\":true,\"dataupdateflag\":true,\"datadeleteflag\":true}")
                .contentType(MediaType.APPLICATION_JSON))
    ...
    void postUserDetailTest4() throws Exception {
        mockMvc.perform(patch("/api/connect/")
